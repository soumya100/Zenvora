...
export const ShortcutsModal: React.FC<ShortcutsModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    ...
    >
      <div
        className="relative w-full max-w-md bg-white dark:bg-zen-bg-darkSurface rounded-3xl overflow-hidden shadow-2xl border border-slate-200 dark:border-zen-bg-darkBorder"
        onClick={(e) => e.stopPropagation()}
      >
        <div className="flex items-center justify-between px-6 py-5 border-b border-slate-200 dark:border-zen-bg-darkBorder">
        ...
        <div className="p-6 divide-y divide-slate-100 dark:divide-zen-bg-darkBorder/60">
          {shortcuts.map((s, idx) => (
